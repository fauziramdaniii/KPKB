...
class CustomersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'activation_code' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'is_active' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '0: not active, 1 : active, 2 : block', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_active' => 1,
                'created' => '2019-10-02 18:19:19',
                'last_login' => '2019-10-02 18:19:19'
            ],
        ];
        parent::init();
    }
