 ...
 * CashPointsFixture
 */
class CashPointsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'from_customer_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'description' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'cash_point' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        ...
        '_indexes' => [
            ...
            'from_customer_id' => ['type' => 'index', 'columns' => ['from_customer_id'], 'length' => []],
            'cash_point_claim_id' => ['type' => 'index', 'columns' => ['cash_point_claim_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-11-21 07:01:44',
                'modified' => '2020-11-21 07:01:44',
            ],
        ];
        parent::init();
    }
