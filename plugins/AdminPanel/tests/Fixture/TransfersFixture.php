...
class TransfersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'target_customer_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'transaction_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'status' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '1', 'comment' => '1 success, 2 failed', 'precision' => null, 'autoIncrement' => null],
        'amount' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => ''],
        'fee' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => ''],
        ...
        '_indexes' => [
            ...
            'target_customer_id' => ['type' => 'index', 'columns' => ['target_customer_id'], 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-01-02 10:21:41',
                'modified' => '2020-01-02 10:21:41'
            ],
        ];
        parent::init();
    }
