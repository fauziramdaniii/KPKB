...
class OrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'invoice' => ['type' => 'string', 'length' => 15, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'order_status_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'stockist_customer_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'recipient_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'recipient_phone' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'gross_total' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => ''],
        'total' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => ''],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
            'stockist_customer_id' => ['type' => 'index', 'columns' => ['stockist_customer_id'], 'length' => []],
        ...
        '_constraints' => [
            ...
            'invoice' => ['type' => 'unique', 'columns' => ['invoice'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'order_status_id' => 1,
                'stockist_customer_id' => 1,
                'customer_id' => 1,
                'province_id' => 1,
                'city_id' => 1,
                'address' => 'Lorem ipsum dolor sit amet',
                'recipient_name' => 'Lorem ipsum dolor sit amet',
                'recipient_phone' => 'Lorem ipsum dolor sit amet',
                'gross_total' => 1,
                'total' => 1,
                'created' => '2019-11-06 03:14:36',
                'modified' => '2019-11-06 03:14:36'
            ],
        ];
        parent::init();
    }
