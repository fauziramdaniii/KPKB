 ...
 *
 */
class RegenciesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'regencies_province_id_index' => ['type' => 'index', 'columns' => ['province_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'regencies_ibfk_1' => ['type' => 'foreign', 'columns' => ['province_id'], 'references' => ['provinces', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
