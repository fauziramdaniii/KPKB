...
class BlogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'view' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-26 07:43:47',
                'modified' => '2019-09-26 07:43:47'
            ],
        ];
        parent::init();
    }
