...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'classname' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => 'for coloring calendar', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'start' => '2020-09-25 08:28:18',
                'end' => '2020-09-25 08:28:18',
                'classname' => 'Lorem ipsum dolor sit amet',
                'user_id' => 1,
                'created' => '2020-09-25 08:28:18',
                'modified' => '2020-09-25 08:28:18',
            ],
        ];
        parent::init();
    }
