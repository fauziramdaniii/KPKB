...
/**
 * AddressRequirementsFixture
 */
class AddressRequirementsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'address_submission_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'address_submission_id' => 1,
                'name' => 'Lorem ipsum dolor sit amet',
                'image_id' => 1,
                'created' => '2021-09-10 07:33:59',
            ],
        ];
        parent::init();
    }
