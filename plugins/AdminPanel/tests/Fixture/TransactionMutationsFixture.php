...
/**
 * TransactionMutationsFixture
 */
class TransactionMutationsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'balance' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => ''],
        ...
        '_indexes' => [
            ...
            'customer_id_2' => ['type' => 'index', 'columns' => ['customer_id', 'transaction_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'amount' => 1,
                'balance' => 1,
                'created' => '2019-10-24 09:52:06',
                'modified' => '2019-10-24 09:52:06'
            ],
        ];
        parent::init();
    }
