 ...
 *
 * @method \AdminPanel\Model\Entity\MlParticipant get($primaryKey, $options = [])
 * @method \AdminPanel\Model\Entity\MlParticipant newEntity($data = null, array $options = [])
 * @method \AdminPanel\Model\Entity\MlParticipant[] newEntities(array $data, array $options = [])
 * @method \AdminPanel\Model\Entity\MlParticipant|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \AdminPanel\Model\Entity\MlParticipant saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \AdminPanel\Model\Entity\MlParticipant patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \AdminPanel\Model\Entity\MlParticipant[] patchEntities($entities, array $data, array $options = [])
 * @method \AdminPanel\Model\Entity\MlParticipant findOrCreate($search, callable $callback = null, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class MlParticipantsTable extends Table
{
    /**
     * Initialize method
     *
