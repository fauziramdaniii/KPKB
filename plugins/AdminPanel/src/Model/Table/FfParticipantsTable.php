 ...
 *
 * @method \AdminPanel\Model\Entity\FfParticipant get($primaryKey, $options = [])
 * @method \AdminPanel\Model\Entity\FfParticipant newEntity($data = null, array $options = [])
 * @method \AdminPanel\Model\Entity\FfParticipant[] newEntities(array $data, array $options = [])
 * @method \AdminPanel\Model\Entity\FfParticipant|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \AdminPanel\Model\Entity\FfParticipant saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \AdminPanel\Model\Entity\FfParticipant patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \AdminPanel\Model\Entity\FfParticipant[] patchEntities($entities, array $data, array $options = [])
 * @method \AdminPanel\Model\Entity\FfParticipant findOrCreate($search, callable $callback = null, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class FfParticipantsTable extends Table
{
    /**
     * Initialize method
     *
