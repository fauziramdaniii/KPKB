            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('Transaction Logs') ?></h3>
                    </div>
                </div>
                <div class="kt-portlet__body">
                                    ...
                                    <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                        <div class="kt-form__group kt-form__group--inline">
                                            ...
                                            <div class="kt-form__control">
                                                <?= $this->Form->select('transaction_type_id', $transactionsTypes, [
                                                    'empty' => 'All',
                    ...
                    <!--begin: Datatable -->
                    <div class="kt_datatable" id="table-transactionMutations"></div>
                    <!--end: Datatable -->
...
<script>
    ...
    var DatatableRemoteAjaxDemo = function() {
        var demo = function() {
            var datatable = $('#table-transactionMutations').KTDatatable({
                data: {
                    type: 'remote',
                    source: {
                        read: {
                ...
                columns: [
...

                    {
                        ...
                        template: function(row) {
                            return row.transaction.txid;
                        }
                    },
                    {
                        field: 'Transactions.transaction_type_id',
                    ...
                    {
                        field: 'TransactionMutations.amount',
                        title: 'Amount',
                        template: function(row) {
                    ...
                    {
                        field: 'TransactionMutations.balance',
                        title: 'Balance',
                        template: function(row) {
                    ...
                    {
                        field: 'TransactionMutations.created',
                        title: 'Created',
                        template: function(row) {
