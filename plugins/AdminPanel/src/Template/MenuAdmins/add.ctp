            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('Add Menu Admin') ?></h3>
                    </div>
                </div>
                ...
                <div class="kt-portlet__body">
                    <?php
                        ...
                        echo $this->Form->control('icon',['class' => $default_class, 'value' => 'kt-menu__link-bullet kt-menu__link-bullet--line']);
                    ?>
