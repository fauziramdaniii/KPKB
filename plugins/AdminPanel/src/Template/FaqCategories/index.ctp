            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('List Faq Categories') ?></h3>
                    </div>
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <div class="kt_datatable" id="table-faqCategories"></div>
                    <!--end: Datatable -->
...
<script>
    ...
    var DatatableRemoteAjaxDemo = function() {
        var demo = function() {
            var datatable = $('#table-faqCategories').KTDatatable({
                data: {
                    type: 'remote',
                    source: {
                        read: {
