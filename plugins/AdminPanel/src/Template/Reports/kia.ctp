...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Laporan Pembuatan KIA</h3>
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Laporan Pembuatan KIA</h3>
                    </div>
                ...
                <div class="kt-portlet__body kt-portlet__body--fluid">
                    <div class="table-responsive">
                        <table class="table table-hover table-striped" id="report_sales">
                            ...
                            <tbody>
                            <?php if($data_kia) : ?>
                                <?php foreach($data_kia as $kias):?>
                                    <tr>
                                        <td><?= $kias->created->format('d F Y');?></td>
                                        <td><?= $kias->classification->name;?></td>
                                        <td><?= $kias->name;?></td>
                                        <td><?= $kias->nik;?></td>
                                        <td><?= $kias->address;?></td>
                                        <td><?= $kias->submission_status->name;?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
                                <tr>
                            ...
                            <?php foreach($kia as $ki) : ?>
                                <thead>
                                    <tr>
                                        <th colspan="6" style="text-align: center;">Total Klasifikasi <?= $ki->name; ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td colspan="6" style="text-align: center;"><?= $ki->total; ?></td>
                                    </tr>
                                </tbody>
                                <thead>
                                    <tr>
