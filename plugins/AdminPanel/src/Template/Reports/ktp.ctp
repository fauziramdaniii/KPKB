...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Laporan Pembuatan KTP</h3>
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Laporan Pembuatan KTP</h3>
                    </div>
                        ...
                        <table class="table table-hover table-striped" id="report_sales">
                            ...
                            <?php if($data_ktp) : ?>
                                <?php foreach($data_ktp as $ktp):?>
                                    <tr>
                                        <td><?= $ktp->created->format('d F Y');?></td>
                                        <td><?= $ktp->classification->name;?></td>
                                        <td><?= $ktp->name;?></td>
                                        <td><?= $ktp->nik;?></td>
                                        <td><?= $ktp->address;?></td>
                                        <td><?= $ktp->submission_status->name;?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
                                <tr>
                            ...
                            <?php foreach($ktps as $ktp) : ?>
                                <thead>
                                    <tr>
                                        <th colspan="6" style="text-align: center;">Total Klasifikasi <?= $ktp->name; ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td colspan="6" style="text-align: center;"><?= $ktp->total; ?></td>
                                    </tr>
                                </tbody>
                                <thead>
                                    <tr>
