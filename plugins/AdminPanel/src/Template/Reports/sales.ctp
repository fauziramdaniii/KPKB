...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Report Sales All Product</h3>
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Sales Statistics All Product</h3>
                    </div>
                </div>
                <div class="kt-portlet__body kt-portlet__body--fluid">
                    <div class="kt-widget-9">
                        <div class="kt-widget-9__chart">
                            <div id="chartdivs" style="width: 100%;height: 500px;"></div>
                        </div>
                    </div>
                </div>
                <div class="kt-portlet__head">
                ...
                <div class="kt-portlet__body kt-portlet__body--fluid">
                    <div class="table-responsive">
                        <table class="table table-hover table-striped" id="report_sales">
                            ...
                            <tbody>
                            <?php foreach($total_order as $order):?>
                                <tr>
                                    <th><?= $order['product'];?></th>
                                    <th><?= $order['total'];?></th>
                                    <th><?= $this->Number->precision($order['price'],2);?></th>
                                    <?php $total_sale = $order['total'] * $order['price']; ?>
                                    <th><?= $this->Number->precision($total_sale,2);?></th>
                                </tr>
                            <?php endforeach;?>
                            <tr>
                                <th colspan="3" style="text-align: center;">Total Seluruh Sales</th>
                                <th><?= $this->Number->precision($total_sales,2);?></th>
                            </tr>
                            </tbody>
                        </table>
                    </div>
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        var products = JSON.parse('<?= json_encode($product_list);?>');
