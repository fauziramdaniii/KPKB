...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Laporan Pembuatan KK</h3>
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Laporan Pembuatan KK</h3>
                    </div>
                        ...
                        <table class="table table-hover table-striped" id="report_sales">
                            ...
                            <?php if($data_kk) : ?>
                                <?php foreach($data_kk as $kk):?>
                                    <tr>
                                        <td><?= $kk->created->format('d F Y');?></td>
                                        <td><?= $kk->classification->name;?></td>
                                        <td><?= $kk->name;?></td>
                                        <td><?= $kk->no_kk;?></td>
                                        <td><?= $kk->address;?></td>
                                        <td><?= $kk->submission_status->name;?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
                                <tr>
                            ...
                            <?php foreach($kks as $kk) : ?>
                                <thead>
                                    <tr>
                                        <th colspan="6" style="text-align: center;">Total Klasifikasi <?= $kk->name; ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td colspan="6" style="text-align: center;"><?= $kk->total; ?></td>
                                    </tr>
                                </tbody>
                                <thead>
                                    <tr>
