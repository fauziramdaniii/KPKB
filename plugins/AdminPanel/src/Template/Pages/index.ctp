            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('List Pages') ?></h3>
                    </div>
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <div class="kt_datatable" id="table-pages"></div>
                    <!--end: Datatable -->
...
<script>
    ...
    var DatatableRemoteAjaxDemo = function() {
        var demo = function() {
            var datatable = $('#table-pages').KTDatatable({
                data: {
                    type: 'remote',
                    source: {
                        read: {
                ...
                columns: [
...

                    {
                        ...
                        template: function(row) {
                            ...
                            return '<span class="'+cls[row.enable]+'">'+status[row.enable]+'</span>' ;
                        }
                    },
