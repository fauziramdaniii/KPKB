            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('Edit Product') ?></h3>
                    </div>
                </div>
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="input file form-group row">
                        <label class="col-form-label col-lg-2">preview</label>
                        <div class="col-lg-7">
                            <?= $this->Html->image('/files/Products/image/thumbnail-' . $product->image); ?>
                        </div>
                    </div>
                    <?php endif; ?>
