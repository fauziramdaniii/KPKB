            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('List Products') ?></h3>
                    </div>
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <div class="kt_datatable" id="table-products"></div>
                    <!--end: Datatable -->
...
<script>
    ...
    var DatatableRemoteAjaxDemo = function() {
        var demo = function() {
            var datatable = $('#table-products').KTDatatable({
                data: {
                    type: 'remote',
                    source: {
                        read: {
                ...
                columns: [
                    ...
                    // {
                    //     field: 'Products.stokist_price',
                    //     title: 'Price Stokist',
                    //     template: function(row) {
                    //         return row.stokist_price;
                    //     }
                    // },
                    {
                    ...
                    // },
                    {
                        field: 'Products.on_sales',
                        title: 'On Stokis Sales',
                        template: function(row) {
                            let cls = {
                            ...
                            return '<span class="'+cls[row.on_sales]+'">'+status[row.on_sales]+'</span>' ;
                        }
                    },
