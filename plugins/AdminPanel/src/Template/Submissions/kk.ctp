...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">KK</h3>
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('Daftar Pengajuan KK') ?></h3>
                    </div>
                </div>
                            ...
                            <div class="tab-content">
                                ...
                                <?php foreach($statusTypes as $key => $status):?>
                                    <div class="tab-pane <?= ($key == 1) ? 'active' : '';?>" id="<?= strtolower($status);?>" role="tabpanel">
                                        ...
                                        <?php endif;?>
                                        <div class="kt_datatable" id="table-kks-<?= strtolower($status);?>"></div>
                                    </div>
                                <?php endforeach;?>
                            </div>
                        </div>
...
<script>
    ...
    function tableWd(status) {
        var options = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    overflow: 'visible',
                    template: function (row, index, datatable) {
                        return '<a href="<?= $this->Url->build(['action' => 'updateKk']); ?>/'+ row.id +'"class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Update Pengajuan KK"><i class="la la-edit"></i></a>';
                    }
                }
            ],
        };
       ...
       if(status != 'menunggu'){
        ...
        var datatable = $('#table-kks-'+status).KTDatatable(options);
