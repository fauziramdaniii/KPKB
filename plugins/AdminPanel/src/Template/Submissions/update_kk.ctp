...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Pengajuan KK</h3>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                ...
                <?= $this->Form->create($kk,['class' => 'kt-form', 'templates' => 'AdminPanel.app_form', 'novalidate', 'type' => 'file']); ?>
                <div class="kt-portlet__body">
                    <?php
                    echo $this->Flash->render();
                    $default_class = 'form-control';
                    $this->Form->setConfig('errorClass', 'is-invalid');
                    echo $this->Form->control('classification',['class' => $default_class, 'label' => 'Klasifikasi', 'value' => $kk->classification->name, 'readonly' => true]);
                    echo $this->Form->control('name',['class' => $default_class, 'label' => 'Nama', 'readonly' => true]);
                    echo $this->Form->control('no_kk',['class' => $default_class, 'label' => 'Nomor KK', 'readonly' => true]);
                    ...
                    <?php if($kk_requirements) : ?>
                        <?php foreach($kk_requirements as $k => $requirement) : ?>
                    ...
                    <?php if($kk->submission_status_id == 2) : ?>
                    ...
                    <?php else : ?>
                        <?php if($kk->submission_status_id == 3 || $kk->submission_status_id == 4) : ?>
                            <?php
                                echo $this->Form->control('tanggal_pengajuan',['class' => $default_class, 'label' => 'Tanggal Pengajuan Berkas', 'value' => $kk->tanggal_pengajuan_berkas->format('d F Y'), 'readonly' => true]);
                                echo $this->Form->control('tanggal_pengambilan',['class' => $default_class, 'label' => 'Tanggal Pengambilan Berkas', 'value' => $kk->tanggal_pengambilan_berkas->format('d F Y'), 'readonly' => true]);
                            ?>
                        <?php endif; ?>
                    <?php endif; ?>

                    <?php if($kk->submission_status_id == 4) : ?>
                        <?php if(empty($kk->taker)) : ?>
                            <?php
                                echo $this->Form->control('submission_status', ['class' => $default_class, 'label' => 'Status Pengajuan', 'value' => $kk->submission_status->name, 'readonly' => true]);
                                echo $this->Form->control('note',['type' => 'textarea', 'class' => $default_class, 'label' => 'Catatan', 'value' => $kk->note, 'readonly' => true]);
                        ...
                        <?php else : ?>
                            ...
                            echo $this->Form->control('submission_status', ['class' => $default_class, 'label' => 'Status Pengajuan', 'value' => $kk->submission_status->name, 'readonly' => true]);
                            echo $this->Form->control('note',['type' => 'textarea', 'class' => $default_class, 'label' => 'Catatan', 'value' => $kk->note, 'readonly' => true]);
                            echo $this->Form->control('taker',['class' => $default_class, 'label' => 'Diambil Oleh', 'value' => $kk->taker, 'readonly' => true]);
                            ?>
                        <?php endif; ?>
                    <?php else : ?>
                        <?php
                        ...
                        <div class="row">
                            ...
                            <?php if($kk->submission_status_id != 4) : ?>
                                <div class="col-10">
                                    ...
                                    <a href="<?= $this->Url->build(['action' => 'kk']); ?>" class="btn btn btn-info"><?= __( 'Kembali'); ?></a>
                                </div>
                            <?php else : ?>
                                <?php if(empty($kk->taker)) : ?>
                                    <div class="col-10">
