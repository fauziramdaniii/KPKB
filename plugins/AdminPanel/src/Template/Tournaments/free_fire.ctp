            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('Peserta Esport Free Fire') ?></h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-toolbar-wrapper">
                            <a href="<?= $this->Url->build(['action' => 'downloadFreefire']); ?>" class="btn btn-default btn-bold btn-upper btn-font-sm" target="_blank"> <i class="la la-download"></i> Download File Dokumen </a>
                ...
                <div class="kt-portlet__body">
                    ...
                    <div  class="table-responsive">
                        <div class="kt_datatable" id="table-ff"></div>
                    </div>
                    <!--end: Datatable -->
...
<script>
    ...
    function delete_data(id) {
        $.post( "<?= $this->Url->build(['action' => 'deleteFf']); ?>/" + id, { _csrfToken: '<?= $this->request->getParam('_csrfToken'); ?>' } )
            .done(function( data ) {
    ...
    var DatatableRemoteAjaxDemo = function() {
        var demo = function() {
            var datatable = $('#table-ff').KTDatatable({
                data: {
                    type: 'remote',
                    source: {
                        read: {
                ...
                columns: [
                    ...
                    {
                        field: 'FfParticipants.team_name',
                        title: 'Nama Tim',
                    ...
                    {
                        field: 'FfParticipants.person_in_charge',
                        title: 'Kontak Person',
                        template: function(row) {
