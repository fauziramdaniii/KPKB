            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('Daftar Live Bagan') ?></h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <a href="<?= $this->Url->build(['action' => 'addBagan']); ?>" class="btn btn-default btn-bold btn-upper btn-font-sm">
                                <i class="flaticon2-add-1"></i>
                                <?= __('Tambah Live Bagan') ?>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="kt-portlet__body">
                    ...
                    <div  class="table-responsive">
                        <div class="kt_datatable" id="table-bagan"></div>
                    </div>
                    <!--end: Datatable -->
...
<script>
    ...
    function delete_data(id) {
        $.post( "<?= $this->Url->build(['action' => 'deleteBagan']); ?>/" + id, { _csrfToken: '<?= $this->request->getParam('_csrfToken'); ?>' } )
            .done(function( data ) {
    ...
    var DatatableRemoteAjaxDemo = function() {
        var demo = function() {
            var datatable = $('#table-bagan').KTDatatable({
                data: {
                    type: 'remote',
                    source: {
                        read: {
