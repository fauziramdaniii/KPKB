...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Edit Album</h3>
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('Edit Album') ?></h3>
                    </div>
                </div>
                <?= $this->Form->create($albums,['class' => 'kt-form', 'templates' => 'AdminPanel.app_form', 'id' => 'form-album']); ?>
                    ...
                    <div class="kt-portlet__foot">
                        <div class="kt-form__actions">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <button type="submit" class="btn btn-success" id="album-submit">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $("#album-submit").click(function(){
                $(':required:invalid', '#form-album').each(function () {
