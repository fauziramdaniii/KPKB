...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Edit Tag</h3>
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title"><?= __('Edit Tag') ?></h3>
                    </div>
                </div>
                <?= $this->Form->create($tag,['class' => 'kt-form', 'templates' => 'AdminPanel.app_form', 'id' => 'form-tag']); ?>
                <div class="kt-portlet__body">
                    <?php
                        echo $this->Flash->render();
                    $default_class = 'form-control';
                    $this->Form->setConfig('errorClass', 'is-invalid');
                    // echo $this->Form->control('name',['class' => $default_class, 'placeholder' => 'Add multiple tags with comma "," separator']);
                    ?>
                ...
                <div class="kt-portlet__foot">
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <button type="submit" class="btn btn-success" id="tag-submit">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $("#tag-submit").click(function(){
        $(':required:invalid', '#form-tag').each(function () {
