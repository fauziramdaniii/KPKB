        ...
        <div class="card card-custom">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <a href="<?= $this->Url->build(['action' => 'add']); ?>" class="btn btn-light-primary font-weight-bold">
                        <i class="ki ki-plus icon-md mr-2"></i> <?= __( 'New Transfer'); ?></a>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div  class="table-responsive">
                    <div class="datatable datatable-bordered datatable-head-custom" id="ajax_data_transfer"></div>
                </div>
                <!--end: Datatable -->
            </div>
        </div>
    ...
    jQuery(document).ready(function() {
         ...
         datatable = $('.datatable').KTDatatable({
            ...
            columns: [
                ...
                {
                    field: 'target_customer.username',
                    title: "<?= __('To');?>",
                },
                {
                    field: 'type',
                ...
                },
                {
                    ...
                    title: "<?= __('Fee');?>",
                    template: function(row) {
                        return (new Intl.NumberFormat('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 2})).format(row.fee);
                    }
                },
                {
                    field: 'description',
