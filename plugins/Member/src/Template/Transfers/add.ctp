        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label"><?= __('Transfer');?></h3>
                </div>
            ...
            <div class="card-body">
                ...
                <?php
                echo $this->Form->create($transfer, ['class' => 'kt-form kt-form--label-right', 'id' => 'kt_profile_form', 'templates' => 'Member.simple_form']);
                $this->Form->setConfig('errorClass', 'is-invalid');
                ?>

                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label"><?= __( 'Destination Username'); ?></label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?= $this->Form->control('amount', [
                            //'value' => \Cake\Core\Configure::read('Transfer.min'),
                            'class' => 'form-control',
                            'label' => false,
                            'div' => false,
                            'autocomplete' => 'off'
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group show-hide-password">
                            ...
                            <?php if ($error = $transfer->getError('password')) : ?>
