            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="<?= $this->Url->build(['action' => 'index']); ?>" class="text-muted"><?= __('Daftar Pengajuan KTP'); ?></a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label"><?= __('Daftar Pengajuan KTP');?></h3>
                </div>
                <div class="card-toolbar">
                    <a href="<?= $this->Url->build(['action' => 'listKtp']); ?>" class="btn btn-light-primary font-weight-bold mr-2">
            ...
            <div class="card-body">
                ...
                <div  class="table-responsive">
                    <div class="datatable datatable-bordered datatable-head-custom" id="ajax_data_ktp"></div>
                </div>
                <!--end: Datatable -->
            </div>
        </div>
...
<script>
    ...
    jQuery(document).ready(function() {
         ...
         datatable = $('#ajax_data_ktp').KTDatatable({
            ...
            columns: [
...

                {
                    ...
                    template: function(row) {
                        return '\
						<a href="<?= $this->Url->build(['action' => 'detailKtp']); ?>/'+ row.id +'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detail Pengajuan">\
