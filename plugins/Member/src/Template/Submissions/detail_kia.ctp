        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label"><?= __('Detail Pengajuan KIA');?></h3>
                </div>

                <div class="card-toolbar">
                    <a href="<?= $this->Url->build(['action' => 'kia']); ?>" class="btn btn-light-primary font-weight-bold">
                        ...
                        <?= __( 'Daftar Pengajuan KIA'); ?></a>
                </div>
            </div>

            <?php
            echo $this->Form->create($kia, ['class' => 'kt-form kt-form--label-right', 'type' => 'file', 'id' => 'kt_profile_form', 'templates' => 'Member.simple_form']);
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?php if($kia->tanggal_pengajuan_berkas) : ?>
                            <?php $tanggal_pengajuan = $kia->tanggal_pengajuan_berkas->format('d F Y'); ?>
                        <?php else : ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?php if($kia->tanggal_pengambilan_berkas) : ?>
                            <?php $tanggal_pengambilan = $kia->tanggal_pengambilan_berkas->format('d F Y'); ?>
                        <?php else : ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?= $this->Form->control('submission_status', [
                            ...
                            'div' => false,
                            'autocomplete' => 'off',
                            'value' => $kia->submission_status->name,
                            'readonly' => true
                        ]); ?>
                    </div>
                </div>
