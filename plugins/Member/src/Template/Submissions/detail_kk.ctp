        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label"><?= __('Detail Pengajuan KK');?></h3>
                </div>

                <div class="card-toolbar">
                    <a href="<?= $this->Url->build(['action' => 'kk']); ?>" class="btn btn-light-primary font-weight-bold">
                        ...
                        <?= __( 'Daftar Pengajuan KK'); ?></a>
                </div>
            </div>

            <?php
            echo $this->Form->create($kk, ['class' => 'kt-form kt-form--label-right', 'type' => 'file', 'id' => 'kt_profile_form', 'templates' => 'Member.simple_form']);
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label"><?= __( 'Nomor KK'); ?></label>
                    <div class="col-lg-9 col-xl-6">
                        <?= $this->Form->control('no_kk', [
                            'class' => 'form-control',
                            'label' => false,
                            'div' => false,
                            'autocomplete' => 'off',
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?php if($kk->tanggal_pengajuan_berkas) : ?>
                            <?php $tanggal_pengajuan = $kk->tanggal_pengajuan_berkas->format('d F Y'); ?>
                        <?php else : ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?php if($kk->tanggal_pengambilan_berkas) : ?>
                            <?php $tanggal_pengambilan = $kk->tanggal_pengambilan_berkas->format('d F Y'); ?>
                        <?php else : ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?= $this->Form->control('submission_status', [
                            ...
                            'div' => false,
                            'autocomplete' => 'off',
                            'value' => $kk->submission_status->name,
                            'readonly' => true
                        ]); ?>
                    </div>
                </div>
