        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label"><?= __('Pengajuan KIA');?></h3>
                </div>
            ...
            <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="custom-file">
                                    ...
                                    <?php if($error = $kia->getError('requirement.'.$k.'.attachment')) : ?>
                ...
                <?php /*
                <?php if($status_pembuatan == '<5 tahun') : ?>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label"><?= __('Bukti Akta Kelahiran Anak');?></label>
                        <div class="col-lg-9 col-xl-6">
                            <div class="custom-file">
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label"><?= __('Bukti KTP Orang Tua');?></label>
                        <div class="col-lg-9 col-xl-6">
                            <div class="custom-file">
                ...
                <?php else : ?>
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label"><?= __('Bukti Foto Anak');?></label>
                        <div class="col-lg-9 col-xl-6">
                            <div class="custom-file">
                                <?= $this->Form->control('attachment4', [
                                    'class' => 'custom-file-input',
                                    'label' => false,
                                    'div' => false,
                                    'type' => 'file',
