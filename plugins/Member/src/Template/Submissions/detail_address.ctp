        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <?= __('Detail Pengajuan Surat Pindah / Datang'); ?>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label"><?= __('Detail Pengajuan Surat Pindah / Datang');?></h3>
                </div>

                <div class="card-toolbar">
                    <a href="<?= $this->Url->build(['action' => 'pindahAlamat']); ?>" class="btn btn-light-primary font-weight-bold">
                        ...
                        <?= __( 'Daftar Pengajuan Surat Pindah / Datang'); ?></a>
                </div>
            </div>

            <?php
            echo $this->Form->create($address, ['class' => 'kt-form kt-form--label-right', 'type' => 'file', 'id' => 'kt_profile_form', 'templates' => 'Member.simple_form']);
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?= $this->Form->control('klasifikasi_pembuatan', [
                            ...
                            'label' => false,
                            'div' => false,
                            'value' => $address->classification->slug,
                            'readonly' => true,
                            'autocomplete' => 'off'
                        ]); ?>
                    </div>
                ...
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label"><?= __( 'Alamat Asal'); ?></label>
                    <div class="col-lg-9 col-xl-6">
                        <?= $this->Form->control('original_address', [
                            'type' => 'textarea',
                            'class' => 'form-control',
                            'type' => 'textarea',
                            'label' => false,
                ...
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label"><?= __( 'Alamat Tujuan'); ?></label>
                    <div class="col-lg-9 col-xl-6">
                        <?= $this->Form->control('destination_address', [
                            ...
                            'div' => false,
                            'autocomplete' => 'off',
                            'value' => $address->destination_address,
                            'readonly' => true
                        ]); ?>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label"><?= __( 'Keterangan'); ?></label>
                    <div class="col-lg-9 col-xl-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?php if($address->tanggal_pengajuan_berkas) : ?>
                            <?php $tanggal_pengajuan = $address->tanggal_pengajuan_berkas->format('d F Y'); ?>
                        <?php else : ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?php if($address->tanggal_pengambilan_berkas) : ?>
                            <?php $tanggal_pengambilan = $address->tanggal_pengambilan_berkas->format('d F Y'); ?>
                        <?php else : ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?= $this->Form->control('submission_status', [
                            ...
                            'div' => false,
                            'autocomplete' => 'off',
                            'value' => $address->submission_status->name,
                            'readonly' => true
                        ]); ?>
                    </div>
                </div>
            ...
            <div class="card-footer">
                <a href="<?= $this->Url->build(['action' => 'pindahAlamat']); ?>" class="btn btn btn-info"><?= __( 'Kembali'); ?></a>
            </div>
