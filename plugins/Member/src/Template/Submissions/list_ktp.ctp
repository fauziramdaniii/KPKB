    ...
    <div class="container">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body d-flex align-items-center py-5 py-lg-13">
                ...
                <!--end::Icon-->
                <!--begin::Description-->
                <div class="m-0 text-dark-50 font-weight-bold font-size-lg">Klasifikasi Pembuatan KTP <br /> Persyaratan harap dibawa ke kecamatan.</div>
                <!--end::Description-->
            </div>
        </div>
        <!--end::Notice-->
                    ...
                    <div class="card card-custom card-stretch wave mb-8 mb-lg-0">
                        <div class="card-body">
                            <div class="d-block p-5 w-100">
                                <div class="">
                                    <a href="<?= $this->Url->build(['action' => 'addKtp', $classification->slug]); ?>" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-5"><?= $classification->name; ?></a>
                        ...
                        <a href="<?= $this->Url->build(['action' => 'addKtp', $classification->slug]); ?>" class="btn btn-primary btn-sm btn-block">Ajukan</a>
                    </div>
                    <!--end::Iconbox-->
                </div>
            <?php endforeach; ?>
