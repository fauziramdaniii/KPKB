    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-1 mr-5"><?= __('KIA');?></h5>
                <!--end::Page Title-->

                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="<?= $this->Url->build(['action' => 'kia']); ?>" class="text-muted"><?= __('Daftar Pengajuan KIA'); ?></a>
                    </li>
                    <li class="breadcrumb-item">
                        <?= __('Klasifikasi Pembuatan KIA'); ?>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
    ...
    <div class="container">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body d-flex align-items-center py-5 py-lg-13">
                ...
                <!--end::Icon-->
                <!--begin::Description-->
                <div class="m-0 text-dark-50 font-weight-bold font-size-lg">Klasifikasi Pembuatan KIA <br /> Persyaratan harap dibawa ke kecamatan.</div>
                <!--end::Description-->
            </div>
        </div>
        <!--end::Notice-->
                    ...
                    <div class="card card-custom card-stretch wave mb-8 mb-lg-0">
                        <div class="card-body">
                            <div class="d-block p-5 w-100">
                                <div class="">
                                    <a href="<?= $this->Url->build(['action' => 'addKia', $classification->slug]); ?>" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-5"><?= $classification->name; ?></a>
                        ...
                        <a href="<?= $this->Url->build(['action' => 'addKia', $classification->slug]); ?>" class="btn btn-primary btn-sm btn-block">Ajukan</a>
                    </div>
                    <!--end::Iconbox-->
                </div>
            <?php endforeach; ?>
            ...
            <div class="col-lg-6 col-xl-6 mb-5">
                ...
                <div class="card card-custom card-stretch wave mb-8 mb-lg-0">
                    <div class="card-body">
                        <div class="d-block p-5 w-100">
                            <div class="">
                                <a href="<?= $this->Url->build(['action' => 'addKia', '<5 tahun']); ?>" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-5">Anak Dibawah 5 Tahun</a>
                                <div class="text-dark-75 mt-5">Persyaratan yang dibutuhkan : <br />
                                <ul>
                                    <li>Foto Copy Akta Kelahiran Anak</li>
                                    <li>KTP Orang Tua</li>
                    ...
                    <a href="<?= $this->Url->build(['action' => 'addKia', '<5 tahun']); ?>" class="btn btn-primary btn-sm btn-block">Ajukan</a>
                </div>
                <!--end::Iconbox-->
            </div>
            <div class="col-lg-6 col-xl-6 mb-5">
                ...
                <div class="card card-custom card-stretch wave mb-8 mb-lg-0">
                    <div class="card-body">
                        <div class="d-block p-5 w-100">
                            <div class="">
                                <a href="<?= $this->Url->build(['action' => 'addKia', '>5 tahun']); ?>" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">Anak Diatas 5 Tahun</a>
                                <div class="text-dark-75 mt-5">Persyaratan yang dibutuhkan : <br />
                                    <ul>
                                        <li>Foto Copy Akta Kelahiran Anak</li>
                                        <li>KTP Orang Tua</li>
