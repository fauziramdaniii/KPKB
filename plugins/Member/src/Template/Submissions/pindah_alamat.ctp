        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label"><?= __('Daftar Pengajuan Surat Pindah / Datang');?></h3>
                </div>

                <div class="card-toolbar">
                    <a href="<?= $this->Url->build(['action' => 'listAddress']); ?>" class="btn btn-light-primary font-weight-bold">
            ...
            <div class="card-body">
                ...
                <div  class="table-responsive">
                    <div class="datatable datatable-bordered datatable-head-custom" id="ajax_data_pindah_alamat"></div>
                </div>
                <!--end: Datatable -->
            </div>
        </div>
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        datatable = $('#ajax_data_pindah_alamat').KTDatatable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    sortable: false,
                    title: "<?= __('Alamat Asal');?>",
                },
                {
                    field: 'destination_address',
                    sortable: false,
                    title: "<?= __('Alamat Tujuan');?>",
                },
                {
...

                {
                    ...
                    template: function(row) {
                        return '\
						<a href="<?= $this->Url->build(['action' => 'detailAddress']); ?>/'+ row.id +'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detail Pengajuan">\
