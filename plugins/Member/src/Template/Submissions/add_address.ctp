        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <?= __('Tambah Pengajuan Surat Pindah / Datang'); ?>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label"><?= __('Pengajuan Surat Pindah / Datang');?></h3>
                </div>
            ...
            <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="custom-file">
                                    ...
                                    <?php if($error = $address->getError('requirement.'.$k.'.attachment')) : ?>
                ...
                <?php /*
                <?php if($status_pembuatan == 'Pindah') : ?>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label"><?= __('Bukti Surat Keterangan Pindah');?></label>
                        <div class="col-lg-9 col-xl-6">
                            <div class="custom-file">
                                <?= $this->Form->control('attachment1', [
                                    'class' => 'custom-file-input',
                ...
                <?php else : ?>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label"><?= __('Bukti Surat Keterangan Datang');?></label>
                        <div class="col-lg-9 col-xl-6">
                            <div class="custom-file">
                                <?= $this->Form->control('attachment1', [
                                    'class' => 'custom-file-input',
