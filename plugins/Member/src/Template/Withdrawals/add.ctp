 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $withdrawal
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="<?= $this->Url->build(['action' => 'index']); ?>" class="text-muted"><?= __('Lists'); ?></a>
                    </li>
                    <li class="breadcrumb-item">
    ...
    <div class="container">
        ...
        <div class="card card-custom">
            ...
            <div class="card-body">
                ...
                <?php
                echo $this->Form->create($withdrawal, ['class' => 'kt-form kt-form--label-right', 'id' => 'kt_profile_form', 'templates' => 'Member.simple_form']);
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <?= $this->Form->control('amount', [
                            'value' => $this->getRequest()->getData('amount', $balance),
                            'class' => 'form-control',
                            'label' => false,
                            'div' => false,
                            'autocomplete' => 'off'
                        ]); ?>
                        <span class="form-text text-muted"><?= __('Your balance');?> <?= $this->Number->currency($balance, 'IDR'); ?>.</span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group show-hide-password">
                            ...
                            <?php if ($error = $withdrawal->getError('password')) : ?>
