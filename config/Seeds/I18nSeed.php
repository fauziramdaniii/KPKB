    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'foreign_key' => '1',
                'field' => 'title',
                'content' => 'Bea materai - keringanan untuk pembeli pertama kali, mengapa tidak investor?',
            ],
            [
                'id' => '6',
                'locale' => 'id',
                ...
                'foreign_key' => '1',
                'field' => 'content',
                'content' => '<p><span style="color: rgb(82, 95, 127); font-family: &quot;Open Sans&quot;, sans-serif; font-size: 16px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Unfortunately, and he has neither an element, or the laughter of a great man, interdum orci. Sound easy, but now members of the protein, laughter players Bureau mass, but law enforcement lorem dolor temperature. That unless blandit ultricies mauris ut diam. In fact, for some football, I do not ornare orci. Fusce aliquet, elit quis tincidunt, lacus lorem egestas magna, nec euismod libero mi cookies. Nullam cursus pain, for example, a thermal hendrerit quam sit amet. Pellentesque risus neque, vitae sollicitudin turpis nisi, bibendum neque mauris metus, ullamcorper diam, no, and in the pool. Unfortunately, some members but hate ullamcorper. Sometimes they malesuada hunger and at the first taste. For soccer sit sterilized in Minneapolis and various temperature. Pellentesque is the gate, grab the ends of the bed so that, before the sem tristique-free, at fringilla arcu urna vitae orci. Unfortunately, none of nutrition stress.</span></p>',
            ],
            [
                'id' => '7',
                'locale' => 'id',
                ...
                'foreign_key' => '2',
                'field' => 'title',
                'content' => 'How to Get Hired in the Tech Industry',
            ],
            [
                'id' => '8',
                'locale' => 'id',
                ...
                'foreign_key' => '2',
                'field' => 'content',
                'content' => '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lacus viverra vitae congue eu consequat ac felis donec et. Integer eget aliquet nibh praesent tristique magna. Aliquam etiam erat velit scelerisque in. Enim ut sem viverra aliquet. Gravida neque convallis a cras semper auctor neque vitae. Cras ornare arcu dui vivamus arcu felis. Pulvinar pellentesque habitant morbi tristique senectus et. Amet luctus venenatis lectus magna. Ullamcorper a lacus vestibulum sed arcu. Vitae nunc sed velit dignissim sodales ut eu sem. Metus aliquam eleifend mi in. Leo integer malesuada nunc vel. Pulvinar proin gravida hendrerit lectus a. Volutpat lacus laoreet non curabitur. Proin libero nunc consequat interdum varius sit amet mattis. Gravida rutrum quisque non tellus orci ac auctor. Eget gravida cum sociis natoque penatibus et. Sollicitudin aliquam ultrices sagittis orci a scelerisque purus semper eget. Amet consectetur adipiscing elit ut aliquam purus sit amet luctus. Orci dapibus ultrices in iaculis nunc sed.</p>',
            ],
            [
                'id' => '9',
                'locale' => 'id',
                ...
                'foreign_key' => '3',
                'field' => 'title',
                'content' => 'The World\'s Worst Tech Advice',
            ],
            [
                'id' => '10',
                'locale' => 'id',
            ...
            [
                ...
                'foreign_key' => '4',
                'field' => 'title',
                'content' => '17 Tech Influencers You Should Follow',
            ],
            [
                'id' => '12',
                'locale' => 'id',
            ...
            [
                ...
                'foreign_key' => '5',
                'field' => 'title',
                'content' => '20 Of The Best Tech Guides',
            ],
            [
                'id' => '14',
                'locale' => 'id',
            ...
            [
                ...
                'foreign_key' => '6',
                'field' => 'title',
                'content' => 'The Tech Experts You Should Be Following Online',
            ],
            [
                'id' => '16',
                'locale' => 'id',
            ...
            [
                ...
                'foreign_key' => '7',
                'field' => 'title',
                'content' => 'Must See YouTube Videos About Tech',
            ],
            [
                'id' => '18',
                'locale' => 'id',
            ...
            [
                ...
                'foreign_key' => '1',
                'field' => 'name',
                'content' => 'Bagaimana cara melakukan order',
            ],
            [
                'id' => '20',
                'locale' => 'id',
            ...
            [
                ...
                'foreign_key' => '1',
                'field' => 'answer',
                'content' => '<p>Anda juga dapat memilih warna-warni, melihat-lihat beberapa fitur, dan melakukan pekerjaan lain di luar dan di luar untuk melakukan lebih baik. Lacus viverra vitae congue eu resultat ac felis donec et. Integer eget aliquet nibh praesent tristique magna. Anda juga dapat menggunakan scelerisque dengan cepat. Gunakan tombol untuk mengaktifkan. Gravida neque convallis adalah seorang pembuat lagu dan video. Cras ornare arcu dui vivamus arcu felis. Habisi pulvinar kebiasaan morbi tristique senectus et. Amet luctus venenatis lectus magna. Ullamcorper sebuah vestibulum sed arcu. Lihat di sini untuk melihat informasi lebih lanjut tentang properti ini.</p>',
            ],
            [
                'id' => '23',
                'locale' => 'id',
...
<ul>
Mengubah<li>Menciptakan pasar   aktif melalui system bagi hasil kepada semua mitra komunitas yang terdiri dari penikmat &amp; penjual Rotama yang telah bergabung didalamnya.</li>
...
<li class="bold">
<h5>Promo</h5>
<p>Gardukita sewaktu-waktu dapat mengadakan kegiatan promosi (selanjutnya disebut sebagai “Promo”) dengan Syarat dan Ketentuan yang mungkin berbeda pada masing-masing kegiatan Promo. Pengguna dihimbau untuk membaca dengan seksama Syarat dan Ketentuan Promo tersebut. </p>
</li>
<li class="bold">
