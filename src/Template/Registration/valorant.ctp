<section id="page-title" class="text-light" style="background-image:url('<?= $this->Url->build('/front-assets-new/images/kategori/valoran.jpg'); ?>'); background-size: cover; background-position: center center;">
    <div class="container">
        ...
        <div class="breadcrumb">
            <ul>
                ...
                <li class="active"><a href="<?= $this->Url->build(['controller' => 'Registration', 'action' => 'valorant' ]); ?>">Valorant</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="content col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <span class="h4">Pendaftaran Peserta Kategori PC (Valorant)</span>
                    </div>
                    <div class="card-body">
                        ...
                        <?php /*
                        <?php echo $this->Form->create('Registration',['url' => ['action' => 'valorant'], 'id' => 'form1', 'class' => 'form-validate', 'type' => 'file']);?>
                        <?= $this->Flash->render(); ?>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <a href="<?= $this->Url->build('/template-file/Template Data Tim (Valorant).docx'); ?>" class="btn btn-outline"><i class="fa fa-download"></i> Download</a>
                                </div>
                                <div class="form-group col-md-12">
