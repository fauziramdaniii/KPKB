        ...
        <div class="container">
            ...
            <div id="logo">
                <a href="<?= $this->Url->build(['controller' => 'Home', 'action' => 'index']); ?>">
                    <span class="logo-default"><img src="<?= $this->Url->build('/front-assets-new/logo-white.png'); ?>"
                            height="50"></span>
                    <span class="logo-dark"><img src="<?= $this->Url->build('/front-assets-new/logo-white.png'); ?>"
                            height="50"></span>
