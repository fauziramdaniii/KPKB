...
<body>
						...
						<div class="tab">
							...
							<div id="tab-1" class="tab-content first-tab">
								<div class="custom-form">
                                    ...
                                    <?= $this->Form->end(); ?>
                                    <style type="text/css">
                                        .grecaptcha-badge{box-shadow: none !important; float: left; margin-bottom: 20px;}
                                    </style>
								</div>
							</div>
							<!--tab end -->
	...
	<?= $this->Html->script([
		...
		'https://maps.googleapis.com/maps/api/js?key=AIzaSyDwJSRi0zFjDemECmFl9JtRj1FY7TiTRRo&amp;libraries=places&amp;callback=initAutocomplete',
		'/front-assets/js/map-single.js'
	]); ?>
